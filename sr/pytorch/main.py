...
trainset = DatasetFromFolder("../trainLabel", zoom_factor=args.zoom_factor)
# trainset = DatasetFromFolder("./train", zoom_factor=args.zoom_factor)
testset = DatasetFromFolder("../testLabel", zoom_factor=args.zoom_factor)
